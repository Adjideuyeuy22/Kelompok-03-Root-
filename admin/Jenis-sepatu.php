                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #9FA8E7;">
                    <div class="sb-sidenav-menu">
                        <div class="nav" >
                            ...
                            <a class="nav-link" href="Data-pelanggan.php" style="color: black;">
                            ...
                            <a class="nav-link" href="Jenis-sepatu"style="color: black;">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Jenis Sepatu</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Interface</li>
                        </ol>
                        <a href="jen_tambah.php"> Tambah</a>    
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    foreach($sql as $s){
                                        ...
                                        <tr>
                                            <td><?=$s['id'] ?></td>
                                            <td><?=$s['nama'] ?></td>
                                            <td><a href="jen_edit.php?id=<?=$s['id'] ?>">Edit </a> | <a href="jen_hapus.php?id=<?=$s['id']?>">Hapus</a> </td>
                                        </tr>
                                        <?php
                                    }
                                    ?>

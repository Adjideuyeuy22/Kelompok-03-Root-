            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Pelangganan</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Interface</li>
                        </ol>
                        <a href="met_tambah.php"> Tambah</a>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    foreach ($sql as $s) {
                                        ...
                                        <tr>
                                            <th><?= $s['id_metode']?></th>
                                            <th><?= $s['nama']?></th>
                                            <th><a href="met_edit.php?id=<?=$s['id_metode'] ?>">Edit </a> | <a href="met_hapus.php?id=<?=$s['id_metode']?>">Hapus</a></th>
                                        </tr>
